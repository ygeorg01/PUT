...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        # additional params
        parser.add_argument('--mask_path', type=str, default='imgs/')
        parser.add_argument('--erosion', type=bool, default=False)
        parser.add_argument('--use_masks', action='store_true', help='Use masks')
        parser.add_argument('--eval_on', action='store_true', help='Evaluation after each epoch')
        parser.add_argument('--eval_path', type=str, default='/home/vcg/Desktop/Urban Enviroment Understanding/pytorch-fid/Evaluation_Imgs/')
        parser.add_argument('--visible_in', action='store_true', help='Use the whole image for consistency loss')
